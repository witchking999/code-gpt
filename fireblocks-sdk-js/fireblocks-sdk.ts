...
export class FireblocksSDK {
    ...
    /**
     *ing(vaultAccou Gets all external wallets for your tenant
     */
    ...
    public async createTransaction(transactionArguments: TransactionArguments, requestOptions?: RequestOptions, travelRuleEncryptionOptions?: TravelRuleEncryptionOptions): Promise<CreateTransactionResponse> {
        ...
        if (transactionArguments?.travelRuleMessage) {
            transactionArguments = await this.apiClient.hybridEncode(transactionArguments, travelRuleEncryptionOptions);
        }
    ...
    export default class FireblocksSDK {
        /**
         * Updates tenant screening configuration
         * @param screeningTenantConfiguration
         */
    ...
    export const fireblocksSDK = new FireblocksSDK();

    // Example usage in routes/api.ts
    export const myRouteHandler = async (req: Request, res: Response) => {
        try {
            const result = await fireblocksSDK.updateTenantScreeningConfiguration(screeningTenantConfiguration);
            res.json(result);
        } catch (error) {
